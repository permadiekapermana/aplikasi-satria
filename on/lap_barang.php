...
<div class="content-wrapper">
        ...
        <h1> Laporan Stok Barang</h1>
            <ol class="breadcrumb">
              ...
              <li><a href="?pg=lapbrg&act=view"><i class="fa fa-dashboard"></i> Laporan Stok Barang</a></li>
             </ol>
        </section>
...
<section class="content">
  <div class="row">
  <div class="col-md-5">
  <form action="?pg=lapbrg&act=cek" method="POST">
      <div class="form-group">
      <label for="exampleInputEmail1">Tanggal Stok Awal</label>
      <input class="form-control" id="date" name="tglpenjualanaw" placeholder="MM/DD/YYY" type="text" required/>
      </div>
  </div>
  <div class="col-md-5">
      <div class="form-group">
      <label for="exampleInputEmail1">Tanggal Stok Akhir</label>
...
WHERE penjualan.tglpenjualan BETWEEN  '$_POST[tglpenjualanaw]' AND  '$_POST[tglpenjualanak]'
