...
if (!empty($_SESSION['sess_id']) || !empty($_SESSION['user_login'])) {
?>
  ...
  <body class="hold-transition skin-purple-light sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index.php?pg=dashboard" class="logo">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <?php
                    $profil = mysql_fetch_array(mysql_query("SELECT * FROM users WHERE id_user = '$_SESSION[sess_id]'"))
                  ?>
      ...
      <footer class="main-footer">
        <div align="center" class="pull-center hidden-xs">
          <b><strong >Copyright &copy; 2019 <a href="webphpmysql.com">Muhamad Akbar</a>.</strong></b>
        </div>
